...
@section('content')
    ...
    <div class="container">
        {{-- Best Deals --}}
        <h1 class="h4 text-center mt-5">Best Deals</h1>
        ...
        <ul class="nav nav_pills nav-pills  mb-3 d-flex justify-content-center mt-2" id="pills-tab" role="tablist">
            ...
            @foreach ($categories as $category)
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link @if ($count1 == 1) active @endif"
                        id="pills-{{ $category->id }}shop-tab" data-toggle="pill"
                        href="#pills-{{ $category->id }}shop" role="tab"
        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            @foreach ($categories as $category)
                <?php $count2++; ?>
                <div class="tab-pane fade @if ($count2 == 1) show active @endif"
                    id="pills-{{ $category->id }}shop" role="tabpanel"
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-unstyled text-small">
                        ...
                        <li><a class="text-muted" href="#"><i class="mr-2 bi bi-telephone"></i>+6281231234123</a>
                        </li>
                    </ul>
                </div>
            </div>
