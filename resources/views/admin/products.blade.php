                                                ...
                                                <form action="/admin-edit-product/{{ $product->id }}" method="POST"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea placeholder="Description" class="form-control @error('description') is-invalid @enderror"
                                                            name="description" id="" cols="30" rows="5" required autocomplete="description" autofocus>{{ $product->description }}</textarea>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <h3 class="text-danger">Are you sure you want to delete
                                                    {{ $product->name }}?</h3>
                                                <p>By deleting "{{ $product->name }}" product, every transaction with
                                                    this product will be deleted</p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-dismiss="modal">Close</button>
